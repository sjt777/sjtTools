//
//  UIView+MGAdaptScreenWidthType.m
//  papayaCar_app
//
...
#import "UIView+MGAdaptScreenWidthType.h"
...
@implementation UIView (MGAdaptScreenWidthType)
...
- (void)adaptScreenWidthWithType:(MGAdaptScreenWidthType)type
    ...
    if (![self isExceptViewClassWithClassArray:exceptViews]) {
        ...
        // 是否要对约束进行等比例
        BOOL adaptConstraint = ((type & MGAdaptScreenWidthTypeConstraint) || type == MGAdaptScreenWidthTypeAll);
        
        // 是否对字体大小进行等比例
        BOOL adaptFontSize = ((type & MGAdaptScreenWidthTypeFontSize) || type == MGAdaptScreenWidthTypeAll);
        
        // 是否对圆角大小进行等比例
        BOOL adaptCornerRadius = ((type & MGAdaptScreenWidthTypeCornerRadius) || type == MGAdaptScreenWidthTypeAll);

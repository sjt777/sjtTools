...
- (void)configCustomNaviBar {
    ...
    _naviBar.backgroundColor = hexColorAlpha(333333,0.9);;
...
- (void)configBottomToolBar {
    ...
    _toolBar.backgroundColor = hexColorAlpha(333333,0.9);;
    ...
    /// FIXME: - 修改
    _doneButton.backgroundColor = hexColor(FF9717);
...
//    _indexLabel.frame = _selectButton.frame;
   ...
   // CGFloat toolBarHeight = [TZCommonTools tz_isIPhoneX] ? 44 + (83 - 49) : 44;
    ...
    _selectButton.frame = CGRectMake(12, 6, 30, 30);
    _indexLabel.frame = _selectButton.frame;
...
- (void)refreshNaviBarAndBottomBarState {
    ...
    _tzImagePickerVc.selectedModels.count > 0 ? [_doneButton setTitle:[NSString stringWithFormat:@"完成(%zd)",_tzImagePickerVc.selectedModels.count] forState:UIControlStateNormal] :  [_doneButton setTitle:_tzImagePickerVc.doneBtnTitleStr forState:UIControlStateNormal];

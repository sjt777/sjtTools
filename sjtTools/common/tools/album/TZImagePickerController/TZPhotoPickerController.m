...
- (void)configBottomToolBar {
    ...
    [_previewButton setTitleColor:hexColor(ffffff) forState:UIControlStateNormal];
    [_previewButton setTitleColor:hexColor(999999) forState:UIControlStateDisabled];
    ...
    _doneButton.enabled ? (_doneButton.backgroundColor = hexColor(FF9717)):(_doneButton.backgroundColor = hexColor(A85D01));
...
- (void)viewDidLayoutSubviews {
    ...
    CGFloat toolBarHeight = [TZCommonTools tz_isIPhoneX] ? 42 + (83 - 49) : 42;
    ...
    _previewButton.frame = CGRectMake(12, 0, previewWidth, 42);
    ...
    _doneButton.frame = CGRectMake(self.view.tz_width - 54 - 12, 9, 54,27);
...
- (void)refreshBottomToolBarStatus {
    ...
    tzImagePickerVc.selectedModels.count > 0 ? [_doneButton setTitle:[NSString stringWithFormat:@"完成(%zd)",tzImagePickerVc.selectedModels.count] forState:UIControlStateNormal] :  [_doneButton setTitle:tzImagePickerVc.doneBtnTitleStr forState:UIControlStateDisabled];
    _doneButton.enabled ? (_doneButton.backgroundColor = hexColor(FF9717)):(_doneButton.backgroundColor = hexColor(A85D01));
